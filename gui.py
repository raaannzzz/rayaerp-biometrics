...
class BiometricWindow(QMainWindow):
    ...
    def setup_window(self):
        ...
        self.setWindowTitle('RAYA ERP Biometric Service')
    ...
    def setup_textboxes_and_label(self):
        ...
        self.create_label("RAYA ERP URL", "erpnext_url", 20, 120, 200, 30)
    ...
    def set_default_value_or_placeholder_of_field(self):
        if os.path.exists("local_config.py"):
            ...
            self.textbox_erpnext_url.setPlaceholderText("example.rayasolutionsph.com")
